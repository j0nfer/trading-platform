...
TESTS = [
    ...
    },
    {
        ...
        "archivo": "comparador_mercados.py",
        "debe_contener": [
    ...
    },
    {
        ...
        "tipo": "ejecucion",
        "comando": ["python", "-X", "utf8", "analizador_patrones.py", "--all"],
    ...
    },
    {
        ...
        "tipo": "ejecucion",
        "comando": ["python", "-X", "utf8", "fuentes_avanzadas.py", "--test"],
